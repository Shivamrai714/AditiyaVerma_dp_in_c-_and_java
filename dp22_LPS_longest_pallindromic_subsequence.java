public class dp22_LPS_longest_pallindromic_subsequence {

    public static void main(String[] args)
    {
        System.out.println("Here we have the Longest Pallindromic Subsequence printing.");
        System.out.println("We will make another string reverse of given , and Find LCS of them , hence both of them will given the LPS ");
        System.out.println("");

        String x="raerddeda";            // ans:  aeddea
